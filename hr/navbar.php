	...
	<div class="container">
		<div class="navbar-header">
			...
			<a class="navbar-brand" href="index.php">
				<strong><img src="/resources/images/logo.png" class="img-responsive"></strong>
			</a>
		</div>
				...
				<li <?php if($activeNav != null && $activeNav == 'appointments') {echo 'class="active"';} ?>>
					<a href="appointments.php">
						...
						<?php 
							...
							$result = mysql_query("SELECT count(*) from appointments where status = 'PENDING'");
							$notificationcount = mysql_result($result, 0);
