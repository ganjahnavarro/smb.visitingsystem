...
<body>
	...
	<div id="pancontainer">
		<div>
			<img id="smblobby" class="panzoom" src="/resources/images/virtuallobby.jpg" usemap="#npcs" alt="SMB">

			<map id="npcs" class="panzoom" name="npcs">
				<area alt="Guard" title="VIRTUAL GUARD" href="#" data-toggle="modal" data-target="#guardModal"
				...
				<area alt="PRODUCTS AND SERVICES" title="PRODUCTS AND SERVICES" href="#" data-toggle="modal" data-target="#PASModal"
					shape="poly" coords="1611,667,1615,673,1832,674,1836,670,1837,335,1833,329,1619,329,1611,333,1611,667" />
				<area alt="WALKTHROUGH" title="WALKTHROUGH" href="#" data-toggle="modal" data-target="#WALKTHROUGHModal"
					shape="poly" coords="269,871,272,877,813,877,816,872,815,385,809,379,275,379,269,383,269,871" />
			</map>
		</div>
	</div>
